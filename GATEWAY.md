...
**Wiring:** Next.js App Router route at src/app/gateway/[[...slug]]/route.ts backed by gateway/next-core.mjs.
**Dev base URL:** `http://localhost:3002`
**Key store:** `data/gateway.json`
...
curl -X POST http://localhost:3002/gateway/admin/keys \
...
curl http://localhost:3002/gateway/v1/ping -H "X-API-Key: <key>"
```
